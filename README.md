...
Project developed to automate the procedures required to create a MicroApp on the Dev CMS. Using REST APIs, the project accepts a request body and deconstructs it to:

1. Get Image from S3 Bucket
2. Load Image to CMS
3. Retrieve uploaded Image details
4. Create MA
5. Update Strapi
